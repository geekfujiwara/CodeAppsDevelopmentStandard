...
# Python 依存パッケージ導入
pip install -r .github/skills/power-platform-standard/requirements.txt
```

#### 共通認証ヘルパー `.github/skills/power-platform-standard/auth_helper.py`
...
python .github/skills/power-platform-standard/auth_helper.py
```
...
6. スクリプトを実行: python .github/skills/copilot-studio-agent/deploy_agent.py
...
- [ ] `pip install -r .github/skills/power-platform-standard/requirements.txt` 実行済み
- [ ] `auth_helper.py` の認証テスト済み（`python .github/skills/power-platform-standard/auth_helper.py`）
