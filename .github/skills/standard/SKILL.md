...
| Phase 4: AI Builder       | `ai-builder`           | AI プロンプト作成（Power Automate から呼ぶ場合）  |
| Phase 5: Power Automate   | `power-automate`       | クラウドフロー作成・接続参照（Code Apps から呼ぶ場合は先に作成）|
| Phase 6: Code Apps        | `code-apps`            | 初期化・デプロイ・Dataverse 接続・フロー統合     |
| Phase 6: Code Apps UI     | `code-apps`            | Code Apps デザインシステム・コンポーネント選定   |
| Phase 6: Power Pages      | `power-pages`          | デプロイ・Dataverse 接続・SPA アップロード        |
| Phase 6: Model-Driven App | `model-driven-app`     | モデル駆動型アプリ作成・SiteMap・公開            |
| Phase 7: Copilot Studio   | `copilot-studio`       | エージェント構築・生成オーケストレーション       |
...
| ルール                                                 | 理由                                                                                                                    |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| 先にデプロイしてから開発                               | Dataverse 接続確立が必要。Power Pages はプロビジョニングに 10〜20 分かかるため、Phase 6 で着手したら完了を待ってから開発を続ける |
