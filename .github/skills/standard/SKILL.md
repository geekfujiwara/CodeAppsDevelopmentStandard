...
| Phase 2: Code Apps UI     | `code-apps`            | Code Apps デザインシステム・コンポーネント選定   |
| Phase 2: Power Pages      | `power-pages`          | デプロイ・Dataverse 接続・SPA アップロード        |
...
| ルール                                                 | 理由                                                                                                                    |
| ------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| 先にデプロイしてから開発                               | Dataverse 接続確立が必要。Power Pages はプロビジョニングに 10〜20 分かかるため、Phase 2 で着手したら完了を待ってから開発を続ける |
