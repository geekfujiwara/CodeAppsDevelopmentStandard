...
`.github/skills/README.md` のサンプル一覧（geek-sales / geek-expense / geek-hr / geek-helpdesk / geek-inventory / geek-asset / geek-contract / geek-pm / geek-maintenance / geek-procurement / geek-approval / geek-quote）を確認し、ユーザーの要件に近いサンプルがあれば紹介する。
