...
> **検証済みリファレンス実装**: `geek_ai`（AIニュース配信）エージェント
...
>
  ...
  >
    ...
    <div
      style="background:#1e3a5f;padding:32px 36px;"
    >
