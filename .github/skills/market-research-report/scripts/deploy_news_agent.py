...
market-research-report スキルに基づく情報収集エージェントの構築:
...
TEAMS_DEVELOPER_NAME = "GeekFujiwara"
...
def find_bot() -> str:
    ...
    print("  ❌ Bot が見つかりません。")
    print()
    print("  Usage: python .github/skills/market-research-report/deploy_news_agent.py <BOT_ID or URL>")
    print()
    ...
    print(f"    5. 再実行: python .github/skills/market-research-report/deploy_news_agent.py <ブラウザURL or GUID>")
    sys.exit(1)
...
def main():
    ...
    print("     → python .github/skills/market-research-report/deploy_news_flow.py <BOT_ID or URL>")
    print()
