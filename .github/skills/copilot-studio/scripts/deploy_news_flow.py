...
Usage:
  python .github/skills/copilot-studio/scripts/deploy_news_flow.py <BOT_ID or URL>
"""
...
def find_bot():
    ...
    print("  ❌ Bot が見つかりません")
    print("  Usage: python .github/skills/copilot-studio/scripts/deploy_news_flow.py <BOT_ID or URL>")
    sys.exit(1)
...
def main():
    ...
    if not flow:
        ...
        print("    4. 再実行: python .github/skills/copilot-studio/scripts/deploy_news_flow.py <BOT_ID or URL>")
        sys.exit(1)
