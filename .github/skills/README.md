...
| 旧パス | 統合先 | 配置場所 |
|--------|--------|----------|
| `docs/POWER_PLATFORM_DEVELOPMENT_STANDARD.md` | `standard` | references/power-platform-development-standard.md |
| `docs/DATAVERSE_GUIDE.md` | `dataverse` | references/dataverse-guide.md |
| `docs/ADVANCED_PATTERNS.md` | `code-apps` | references/advanced-patterns.md |
| `docs/CONNECTOR_REFERENCE.md` | `code-apps` | references/connector-reference.md |
| `SAMPLES.md` | `standard` | references/samples.md |
| `src/`, `plugins/`, `styles/`, `public/` | `code-apps` | template/ |
| `package.json`, `vite.config.ts`, `tsconfig*.json` 等 | `code-apps` | template/ |
| `.env.example`, `patch-nameutils.cjs`, `components.json` | `code-apps` | template/ |
| `.vscode/` | `code-apps` | template/.vscode/ |
