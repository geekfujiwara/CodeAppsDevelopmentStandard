...
test("agent-generated land-aware JSON passes the application validator and uses matching footprints", () => {
  ...
  const script = "import sys,json; sys.path.insert(0,'agent-skill'); from design_plant import create_layout,footprint; source,site=json.load(sys.stdin); design=create_layout(source,site); print(json.dumps({'design':design,'bounds':[list(footprint(design,unit).bounds) for unit in design['units']]}))"
