  ...
  return (
    <>
      ...
      >
        ...
        {/* 使い方ガイド（ルートを持たないのでナビとは別に置く） */}
        <div className={cn("border-t border-border", isCollapsed ? "p-1" : "p-2")}>
          <button
            type="button"
            onClick={openGuide}
            title={isCollapsed ? "使い方ガイド" : undefined}
            className={cn(
              "group relative flex w-full items-center rounded-lg transition-all duration-200 hover:bg-[var(--accent-hover)]",
