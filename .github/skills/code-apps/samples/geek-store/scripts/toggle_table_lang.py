...
TABLES = [
    (f"{PREFIX}_store",       "Store",       "Stores",       "店舗",         "店舗一覧"),
    (f"{PREFIX}_store_audit", "Store Audit", "Store Audits", "臨店チェック", "臨店チェック一覧"),
    (f"{PREFIX}_audit_item",  "Audit Item",  "Audit Items",  "チェック項目", "チェック項目一覧"),
]
