...
TABLES = [
    (f"{PREFIX}_employee",   "Employee",   "Employees",   "社員台帳",      "社員台帳一覧"),
    (f"{PREFIX}_recruitment","Recruitment","Recruitments","採用ポジション", "採用ポジション一覧"),
    (f"{PREFIX}_candidate",  "Candidate",  "Candidates",  "候補者",         "候補者一覧"),
    (f"{PREFIX}_evaluation", "Evaluation", "Evaluations", "評価",           "評価一覧"),
]
