...
TABLES = [
    (f"{PREFIX}_product",        "Product",       "Products",       "商品マスタ", "商品マスタ一覧"),
    (f"{PREFIX}_stock_movement", "Stock Movement","Stock Movements","入出庫記録", "入出庫記録一覧"),
    (f"{PREFIX}_order",          "Order",         "Orders",         "発注管理",   "発注管理一覧"),
]
