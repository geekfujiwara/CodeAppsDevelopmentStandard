...
TABLES = [
    (f"{PREFIX}_asset",           "Asset",           "Assets",           "資産台帳",   "資産台帳一覧"),
    (f"{PREFIX}_loan",            "Loan",            "Loans",            "貸出管理",   "貸出管理一覧"),
    (f"{PREFIX}_disposal",        "Disposal",        "Disposals",        "廃棄管理",   "廃棄管理一覧"),
    (f"{PREFIX}_inventory_check", "Inventory Check", "Inventory Checks", "棚卸",       "棚卸一覧"),
]
