...
TABLES = [
    (f"{PREFIX}_equipment",  "Equipment",           "Equipment",           "設備マスタ",       "設備マスタ一覧"),
    (f"{PREFIX}_work_order", "Work Order",          "Work Orders",         "作業指示",         "作業指示一覧"),
    (f"{PREFIX}_schedule",   "Maintenance Schedule","Maintenance Schedules","点検スケジュール","点検スケジュール一覧"),
]
