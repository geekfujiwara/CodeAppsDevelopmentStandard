...
export const router = createHashRouter([
  {
    ...
    children: [
      ...
      { path: "quotes",      element: <Suspense fallback={null}><Quotes /></Suspense>      },
      { path: "quotes/:id",  element: <Suspense fallback={null}><QuoteDetail /></Suspense> },
      { path: "invoices",    element: <Suspense fallback={null}><Invoices /></Suspense>    },
