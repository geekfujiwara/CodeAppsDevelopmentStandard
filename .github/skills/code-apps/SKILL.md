...
| [ビルドリファレンス](references/build-reference.md) | ビルド・デプロイの詳細手順・TypeScript エラー対処 |
...
| [データソースパターン](references/data-source-patterns.md) | SDK 生成サービス・dataSourcesInfo・getClient() の使い方 |
...
Dataverse SDK（`getClient()`）経由のデータアクセスのみ CSP 安全。
