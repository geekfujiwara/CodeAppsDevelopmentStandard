...
新しい Power Pages サイトの設計時は、まず **[デザインテンプレート集](design-templates.md)** を読み込み、ユーザーにテンプレートを提案すること。

**ワークフロー**:
1. `design-templates.md` を読み込む
2. テンプレート一覧表をユーザーに提示
3. ユーザーが番号で選択
4. 選択テンプレートの CSS Variables / フォント / シャドウを適用
5. デフォルト未指定の場合は **1. Indigo / Violet** を使用
...
**[デザインテンプレート集](design-templates.md)** から選択して適用する。
テンプレートにない独自配色が必要な場合は、テンプレートのフォーマットに従って `:root` / `.dark` を直接編集する。
