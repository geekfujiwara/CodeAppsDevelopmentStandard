...
| [scripts/build_browser_bundle.mjs](scripts/build_browser_bundle.mjs) | runner を統合ブラウザのツール sandbox で `new Function` 評価できる形に変換し、承認済み plan を hash 検証してファイル SHA-256 を出す | なし（生成のみ） |
