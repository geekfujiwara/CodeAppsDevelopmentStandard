...
/* DialogTitle に DismissRegular アイコンボタン */
/* DialogContent: flex column, gap: 16px */
/* Field + Input / ボタン式 Choice */
/* 読み取り専用情報: 小さいテキストで設備名・種別・予定日を横並び表示 */
/* DialogActions: 「詳細を開く」(OpenRegular) + 「保存」(SaveRegular, appearance="primary") */
```
