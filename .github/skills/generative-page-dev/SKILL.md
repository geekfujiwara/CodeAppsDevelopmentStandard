...
description: "Power Apps Generative Pages (genux) の開発・デバッグ・デプロイ。React 17 + TypeScript + Fluent UI V9 + D3.js の単一ファイル構成。デザインテンプレート (design-template.md) による段階的 UI 改善。Use when: generative page, genpage, genux, pac model genpage, DataAPI, Fluent UI V9, D3 chart, model-driven app page, generative page deploy, generative page debug, デザイン改善, ダッシュボード, KPI, チャート, アニメーション"
...
デザインパターン・UI カタログ・チャート選定ガイドの詳細は [デザインテンプレート](design-template.md) を参照。
...
| ファイル | 内容 |
|---|---|
| [design-template.md](design-template.md) | 4構築パターン（入力ウィザード/KPI/カンバン/ガント）、UIカタログ、チャート選定ガイド |
| [code-patterns.md](code-patterns.md) | DataAPI・D3 チャート・DataGrid のコードパターン |
| [troubleshooting.md](troubleshooting.md) | ランタイムエラー・デプロイ問題の対処法 |
