...
export default function AssetsPage() {
      ...
      render: (item) => (
        <div className="flex gap-1">
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              startEdit(item as Geek_itassets);
            }}
          >
          ...
          <AlertDialog>
            ...
            <AlertDialogContent className="z-[400]">
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction
                  onClick={() => handleDelete(item.geek_itassetid)}
                >
                  削除
                </AlertDialogAction>
              </AlertDialogFooter>
  ...
  const startEdit = (asset: Geek_itassets) => {
    ...
    setFormType(
      asset.geek_assettype != null ? String(asset.geek_assettype) : "",
    );
  ...
  const handleSave = () => {
    ...
    if (editingAsset) {
      updateMutation.mutate(
        { id: editingAsset.geek_itassetid, ...payload },
        {
          onSuccess: () => {
