...
import {
  LinkConfirmModal,
  useLinkModal,
} from "@/components/link-confirm-modal";
import {
  GraduationCap,
  MessageSquare,
  LayoutGrid,
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col items-center space-y-8 px-6 text-center">
        ...
        <div className="space-y-4">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            この開発テンプレートは、Microsoft Learn
            データをサンプルとして活用し、ダッシュボード、フォーム、ギャラリー、フィルター、カード表示などの実装パターンを紹介します。
            Vite / TypeScript / React をベースに、API 連携やモダン UI
            の実装例を提供します。
          </p>
